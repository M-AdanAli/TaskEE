...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar">
            ...
            <div class="nav-links">
                <a href="${pageContext.request.contextPath}/tasks">Dashboard</a>
            ...
            <div class="card" style="padding: 2.5rem; border-top: 5px solid var(--brand-orange);">
                ...
                <form action="${pageContext.request.contextPath}/tasks/${not empty task ? 'update' : 'save'}" method="post">
                    ...
                    <div style="margin-top: 3rem; padding-bottom: 2rem; display: flex;">
                        ...
                        <a href="${pageContext.request.contextPath}/tasks" class="btn btn-secondary" style="margin-left: 10px; padding: 12px 24px; font-size: 1rem;">
                            Cancel
                        </a>
                    </div>
                </form>
